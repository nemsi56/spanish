...
const TOPICS = [
  {
    ...
    drills: [
      ...
      { sentence: "Mis padres ___ profesores.", answer: "son", options: ["son", "están", "fueron", "estaban"], translation: "My parents are teachers.", explanation: "Profession → ser.", verb: "ser", tense: "present", pronounIndex: 4 },
      ...
      { sentence: "Ustedes ___ muy ocupados esta semana.", answer: "están", options: ["están", "son", "estuvieron", "fueron"], translation: "You all are very busy this week.", explanation: "Temporary condition, present → estar.", verb: "estar", tense: "present", pronounIndex: 4 },
      { sentence: "Mis abuelos ___ de Colombia.", answer: "son", options: ["son", "están", "fueron", "estaban"], translation: "My grandparents are from Colombia.", explanation: "Origin → ser, present.", verb: "ser", tense: "present", pronounIndex: 4 }
    ]
  }
];
